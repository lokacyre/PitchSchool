...
const contractABI = require("../artifacts/contracts/Pitchschool.sol/Pitchschool.json").abi;

program
    .name("pitchschool-cli")
    .description("CLI tool for Pitchschool smart contract")
    .version("1.0.0");
