 ...
 * This file demonstrates how to integrate Pitchschool with a web frontend
 */

// For React/Vue/Angular applications
export class PitchschoolClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new PitchschoolClient(provider, contractAddress);
